...
export default function Header() {
  ...
  <Nav.Item>
    <Nav.Link className={myHeader.hvrPush} href="/login"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
